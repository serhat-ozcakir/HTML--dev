...
const displayMenu = (items) => {
    menuList.innerHTML = ""; // önce eski öğeleri temizle
    items.forEach(item => {
        let col = document.createElement("div");
        col.classList.add("col-sm-6", "card-voll", "mb-3");

        col.innerHTML = `
      <div class="card mt-5 h-100 d-flex flex-row " style="">
        <div>
